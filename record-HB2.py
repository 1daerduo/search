...
for file_path in file_paths:
    ...
    pattern = r"camera_(\d+).*record_time:(\d+).*ms.*snapshot"
...
for num in sorted_dict:
    print('cam:',num, 'SN:', stream_dict[num].get('SN', 'N/A'),'录像计数:', sorted_dict[num]['count'], '总计录像时间(ms):',sorted_dict[num]['total_record'])